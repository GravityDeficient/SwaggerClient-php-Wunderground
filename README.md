# SwaggerClient-php-Wunderground
...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/ShaneEaston/SwaggerClient-php-Wunderground.git"
    }
  ],
  "require": {
    "shaneeaston/swaggerclient-php-wunderground": "*@dev"
  }
}
```
...
## Documentation For Models
 ...
 - [Measurements](docs/Model/Measurements.md)
